...
import  {marketsReducer, marketReducer,productsReducer } from './marketReducer'
...
const reducers = combineReducers({
  ...
  ,addFeedbackReducer,
  getFeedbackByUserId,
  getReservationsReducer,getFeedbackReducter,removeFeedbackReducer,getReservationByUserIdReducer
});
