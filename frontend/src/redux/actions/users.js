...
const usersActions = {
    ...
    makereservation: (data) => async (dispatch) => {
      ...
      try {
        ...
        toast.error('ERROR RESERVATION'+error)
        dispatch({
...
getReservations: () => async (dispatch) => {
  try {
    ...
    toast.error('ERROR GETTING RESERVATIONS'+error)
    dispatch({
...
getFeedbacks: () => async (dispatch) => {
  try {
    ...
    toast.error('ERROR GETTING FEEDBACKS'+error)
    dispatch({
...
removeFeedback: (data) => async (dispatch) => {
  try {
    ...
    toast.error('ERROR REMOVINGS FEEDBACK'+error)
    dispatch({
